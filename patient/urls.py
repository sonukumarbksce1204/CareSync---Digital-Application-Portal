...
urlpatterns = [
    ...
    path('appointments/choose/', views.choose_booking_path, name='choose_booking_path'),
    path('appointments/book/', views.book_appointment, name='book_appointment'),
    path('appointments/book/hospital/<int:hospital_id>/', views.book_hospital_appointment, name='book_hospital_appointment'),
    path('hospitals/<int:hospital_id>/book/', views.hospital_booking_choice, name='hospital_booking_choice'),
